...
# Load elite tech leaders batch
new_authors = load_dataset("/tmp/batch_10_tech_leaders_recovered.jsonl")
print(f"Loaded {len(new_authors)} new elite tech leaders")
...
print("✅ Elite tech leaders merge completed successfully!")
