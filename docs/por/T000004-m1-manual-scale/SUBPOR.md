...
- Next (single, decidable, <=30 minutes): **M1 Week 1 Batch Preparation** - Create .cccc/work/m1/week1/ directory structure + lists/seeds/m05-ai-tech-batch.csv scaffold (first 25 handles per domain rotation plan); commit batch 0.5 artifacts (velocity.log, qa_sample.csv, harvest.raw.jsonl, pipeline.log) with evidence summary; update T000004 stage from "proposed" to "active" in execution phase
