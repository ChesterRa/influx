#!/usr/bin/env python3
"""
Convert batch 29 profiles to Influx schema format
"""
...
def main():
    # Load raw profiles
    with open("tmp_batch_29_raw.json", "r") as f:
    ...
    with open("tmp_batch_29_converted.jsonl", "w") as f:
    ...
    print(f"- Saved to: tmp_batch_29_converted.jsonl")
