#!/usr/bin/env python3
"""
Fix handles that exceed Twitter's 15-character limit
"""
...
def fix_handles(input_file, output_file):
    ...
    with open(input_file, "r") as infile, open(output_file, "w") as outfile:
        for line in infile:
            ...
            # Fix handles that are too long or contain spaces
            if len(handle) > 15 or " " in handle:
                original_handle = handle

                # Remove spaces and truncate to 15 characters
...
if __name__ == "__main__":
    fix_handles("data/latest/latest_with_m15.jsonl", "data/latest/latest_fixed.jsonl")
