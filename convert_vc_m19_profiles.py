#!/usr/bin/env python3
"""
Convert VC M19 profiles to Influx schema format
"""
...
def main():
    # Load raw profiles
    with open("tmp_vc_m19_raw.json", "r") as f:
    ...
    with open("tmp_vc_m19_converted.jsonl", "w") as f:
        for profile in influx_profiles:
            f.write(json.dumps(profile) + "\n")

    print(f"Converted {len(influx_profiles)} VC profiles to Influx schema")
    ...
    print(f"- Saved to: tmp_vc_m19_converted.jsonl")
