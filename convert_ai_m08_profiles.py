#!/usr/bin/env python3
"""
Convert AI M08 research profiles to Influx schema format
"""
...
def main():
    # Load raw profiles
    with open("tmp_ai_m08_raw.json", "r") as f:
    ...
    with open("tmp_ai_m08_converted.jsonl", "w") as f:
        for profile in influx_profiles:
            f.write(json.dumps(profile) + "\n")

    print(f"Converted {len(influx_profiles)} AI research profiles to Influx schema")
    ...
    print(f"- Saved to: tmp_ai_m08_converted.jsonl")
